    ...
    <div class="DetailsMain">
        ...
        <div class="nav">
            <div class="one">
                ...
                <router-link to="/Tmall" tag="p" class="zhuan">天猫转让列表 ></router-link>
                <p>{{companyinformation.service_name}}天猫店铺</p>
            </div>
            <div class="two">
        ...
        <div class="screen">
            <div class="margin">
                <div class="left">
                    <div class="leftOne">
                        <div class="loo">
                            <img src="../../assets/images/tmall_logo.png" alt="">
                            <p>华东地区，婴童用品旗舰店，基本全开，多个商标，三字适合做品牌华东地区，婴童用品旗舰店，基本全开，多个商标，三字适合做品牌</p>
                        </div>
						<div class="loo1">
						    <p>描述:华东地区，婴童用品旗舰店，基本全开，多个商标，三字适合做品牌华东地区，婴童用品旗舰店，基本全开，多个商标，三字适合做品牌</p>
						</div>
                    </div>
                    <div class="leftTwo">
                        <div>
                            <p>{{companyinformation.company_trade}}5454</p>
                            <span>商城类型</span>
                        </div>
                        <div>
                            <p>{{companyinformation.fund_date}}4545</p>
                            <span>主营类目</span>
                        </div>
                        <div>
                            <p>{{companyinformation.tax_type}}4545</p>
                            <span>提供货源</span>
                        </div>
                        <div>
                            <p>{{companyinformation.registered_capital}}45万人民币</p>
                            <span>注册资本</span>
                        </div>
                        <div>
                            <p>{{companyinformation.bank_account_open}}4545</p>
                            <span>所在地区</span>
                        </div>
                        <div>
                            <p>{{companyinformation.service_province_code}}4545</p>
                            <span>贷款状态</span>
                        </div>
						<div>
						    <p>{{companyinformation.service_province_code}}4545</p>
        ...
        .screen{
            ...
            .margin{
                ...
                .left{
					...
					background-image: url(../../assets/images/aspect_bg_1.png);
                    ...
                    .leftThree{
						...
						width:96%;
						border-radius: 5px;
						background: linear-gradient(to right, #B8B4F7 30%, #80D6FF 70%);
						background-color: rgba(255,255,255,0.2);
                        position: relative;
                        .price{
							padding:0 20px;
